...
Backend}\label{resumen-de-cambios-backend}
...
\bottomrule\noalign{}
\endlastfoot
Seguridad & Definición de separación estricta entre perfiles de
Administrador y Estudiante. \\
Infraestructura & Validación del almacenamiento en MongoDB (500 MB) como
escalable y suficiente. \\
\end{longtable}
}
...
\subsection{Lista de Estudiantes}\label{lista-de-estudiantes}
...
\subsection{Panel del Estudiante}\label{panel-del-estudiante}
...
\subsection{Resumen de cambios ---
Frontend}\label{resumen-de-cambios-frontend}
...
\bottomrule\noalign{}
\endlastfoot
Prototipo & Presentación y validación del diseño visual inicial con ABAQ
Querétaro. \\
Requerimientos & Definición de funcionalidades para campañas y
...
\textbf{Grabación de la sesión:} -
\href{https://drive.google.com/file/d/12Xn17K2BIbEWz3Z9l_Kl-2G0lruFW_V7/view?usp=drive_web}{Video
de la reunión (Google Drive)} -
\href{https://docs.google.com/document/d/1g4qWQUz1eiLQI4deqAT1OupZSXW5JZhgj2tcH8KcMl0/edit?usp=drive_web}{Transcripción
completa}
